    ...
    <>
      <section className="h-full w-full pt-36 relative flex items-center justify-center flex-col">
        ...
        <div className="flex justify-center items-center relative md:mt-[-70px] ">
          <Image src={'/assests/preview.png'} alt="preview" height={1200} width={1200} className="rounded-tl-2xl rounded-tr-2xl border-2 border-muted" />
          ...
          {pricingCards.map((card) => (
            <Card key={card.title} className={clsx('w-[300px] flex flex-col justify-between', {
              ...
              <CardHeader>
                ...
                <CardFooter className="flex p-0 flex-col items-start gap-4">
                  ...
                  <Link href={`/agency?plan=${card.priceId}`} className={clsx('w-full text-center bg-primary p-2 rounded-md',{'!bg-muted-foregorund':card.title !== 'Unlimited Saas'})}>Get Started</Link>
                </CardFooter>
              </CardHeader>
            </Card>
          ))}
